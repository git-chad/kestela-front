...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Kestela</title>
      </Head>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-justify">
          ...
          <div className="[&>br]:my-1 py-10">
            <span>
              Privacy Policy
              <br /> Last updated: September 18, 2021
              <br />
              ...
              <br /> We use Your Personal data to provide and improve the Service. By
              ...
              <br />
              <br /> Interpretation
              <br /> The words of which the initial letter is capitalized have meanings
              ...
              <br /> Account means a unique account created for You to access our Service
              or parts of our Service.
              <br /> Affiliate means an entity that controls, is controlled by or is under
              ...
              <br /> Application means the software program provided by the Company
              downloaded by You on any electronic device, named Kestela
              <br /> Company (referred to as either "the Company", "We", "Us" or "Our" in
              this Agreement) refers to Kestela.
              <br /> Country refers to: United Kingdom
              <br /> Device means any device that can access the Service such as a
              computer, a cellphone or a digital tablet.
              <br /> Personal Data is any information that relates to an identified or
              identifiable individual.
              <br /> Service refers to the Application.
              <br /> Service Provider means any natural or legal person who processes the
              data on behalf of the Company. It refers to third-party companies or
              individuals employed by the Company to facilitate the Service, to provide
              the Service on behalf of the Company, to perform services related to the
              Service or to assist the Company in analyzing how the Service is used.
              <br /> Usage Data refers to data collected automatically, either generated
              ...
              <br /> When You access the Service by or through a mobile device, We may
              ...
              diagnostic data.
              <br /> We may also collect information that Your browser sends whenever You
              ...
              <br /> To provide and maintain our Service, including to monitor the usage
              of our Service.
              <br /> To manage Your Account: to manage Your registration as a user of the
              Service. The Personal Data You provide can give You access to different
              functionalities of the Service that are available to You as a registered
              user.
              <br /> For the performance of a contract: the development, compliance and
              ...
              <br /> To contact You: To contact You by email, telephone calls, SMS, or
              other equivalent forms of electronic communication, such as a mobile
              application's push notifications regarding updates or informative
              communications related to the functionalities, products or contracted
              services, including the security updates, when necessary or reasonable for
              their implementation.
              <br /> To provide You with news, special offers and general information
              ...
              <br /> For business transfers: We may use Your information to evaluate or
              ...
              transferred.
              <br /> For other purposes: We may use Your information for other purposes,
              ...
              <br /> With Service Providers: We may share Your personal information with
              Service Providers to monitor and analyze the use of our Service, to contact
              You.
              <br /> For business transfers: We may share or transfer Your personal
              ...
              <br /> With Affiliates: We may share Your information with Our affiliates,
              ...
              control with Us.
              <br /> With business partners: We may share Your information with Our
              business partners to offer You certain products, services or promotions.
              <br /> With other users: when You share personal information or otherwise
              interact in the public areas with other users, such information may be
              viewed by all users and may be publicly distributed outside.
              <br /> With Your consent: We may disclose Your personal information for any
              other purpose with Your consent.
              <br />
              <br /> Retention of Your Personal Data
              <br />
              <br /> The Company will retain Your Personal Data only for as long as is
              ...
              <br /> Your consent to this Privacy Policy followed by Your submission of
              such information represents Your agreement to that transfer.
              <br /> The Company will take all steps reasonably necessary to ensure that
              ...
              <br /> If the Company is involved in a merger, acquisition or asset sale,
              Your Personal Data may be transferred. We will provide notice before Your
              Personal Data is transferred and becomes subject to a different Privacy
              Policy.
              <br /> Law enforcement
              <br /> Under certain circumstances, the Company may be required to disclose
              Your Personal Data if required to do so by law or in response to valid
              requests by public authorities (e.g. a court or a government agency).
              <br /> Other legal requirements
              <br /> The Company may disclose Your Personal Data in the good faith belief
              that such action is necessary to:
              <br /> Comply with a legal obligation
              <br /> Protect and defend the rights or property of the Company
              <br /> Prevent or investigate possible wrongdoing in connection with the
              Service
              ...
              <br />
              <br /> The security of Your Personal Data is important to Us, but remember
              ...
              <br /> Our Service does not address anyone under the age of 13. We do not
              ...
              from Our servers.
              <br /> If We need to rely on consent as a legal basis for processing Your
              ...
              <br /> Our Service may contain links to other websites that are not operated
              ...
              <br /> We have no control over and assume no responsibility for the content,
              ...
              <br /> You are advised to review this Privacy Policy periodically for any
              ...
              us:
              <br /> By email: milton.slonim@gmail.com
            </span>
          </div>
        </div>
      </div>
