...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Terms & Conditions - Kestela</title>
      </Head>
        ...
        <div className="mx-auto max-w-4xl text-justify">
          ...
          <div className="[&>br]:my-1 py-10">
            <span>
              ...
              use of Kestela's Website, located at https://www.kestela.com/.
              <br />
              <br /> By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Kestela if you do not agree to take all
              of the terms and conditions stated on this page.
              <br /> The following terminology applies to these Terms and Conditions,
              Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You"
              and "Your" refers to you, the person log on this website and compliant to
              ...
              <br /> Cookies
              <br />
              <br /> We employ the use of cookies. By accessing Kestela, you agreed to use
              cookies in agreement with the Kestela's Privacy Policy.
              <br /> Most interactive websites use cookies to let us retrieve the user’s
              ...
              <br /> License
              <br />
              <br /> Unless otherwise stated, Kestela and/or its licensors own the
              intellectual property rights for all material on Kestela. All intellectual
              property rights are reserved. You may access this from Formula Studio for
              your own personal use subjected to restrictions set in these terms and
              conditions.
              <br />
              <br /> You must not:
              <br /> Republish material from Kestela
              <br /> Sell, rent or sub-license material from Kestela
              <br /> Reproduce, duplicate or copy material from Kestela
              <br /> Redistribute content from Kestela
              ...
              exchange opinions and information in certain areas of the website. Formula
              Studio does not filter, edit, publish or review Comments prior to their
              presence on the website. Comments do not reflect the views and opinions of
              Kestela,its agents and/or affiliates. Comments reflect the views and
              opinions of the person who post their views and opinions. To the extent
              permitted by applicable laws, Kestela shall not be liable for the Comments
              ...
              website.
              <br /> Kestela reserves the right to monitor all Comments and to remove any
              Comments which can be considered inappropriate, offensive or causes breach
              of these Terms and Conditions.
              <br />
              <br /> You warrant and represent that:
              <br /> You are entitled to post the Comments on our website and have all
              necessary licenses and consents to do so;
              <br /> The Comments do not invade any intellectual property right, including
              without limitation copyright, patent or trademark of any third party;
              <br /> The Comments do not contain any defamatory, libelous, offensive,
              indecent or otherwise unlawful material which is an invasion of privacy
              <br /> The Comments will not be used to solicit or promote business or
              custom or present commercial activities or unlawful activity.
              <br /> You hereby grant Kestela a non-exclusive license to use, reproduce,
              ...
              <br /> The following organizations may link to our Website without prior
              written approval:
              <br /> Government agencies;
              <br /> Search engines;
              <br /> News organizations;
              <br /> Online directory distributors may link to our Website in the same
              ...
              <br /> These organizations may link to our home page, to publications or to
              ...
              <br /> We may consider and approve other link requests from the following
              ...
              <br /> We will approve link requests from these organizations if we decide
              that: (a) the link would not make us look unfavorably to ourselves or to our
              ...
              compensates the absence of Kestela; and (d) the link is in the context of
              ...
              <br /> If you are one of the organizations listed in paragraph 2 above and
              are interested in linking to our website, you must inform us by sending an
              e-mail to Kestela. Please include your name, your organization name, contact
              information as well as the URL of your site, a list of any URLs from which
              you intend to link to our Website, and a list of the URLs on our site to
              ...
              <br /> By use of any other description of our Website being linked to that
              makes sense within the context and format of content on the linking party’s
              site.
              <br /> No use of Kestela's logo or other artwork will be allowed for linking
              absent a trademark license agreement.
              <br />
              <br /> iFrames
              <br /> Without prior approval and written permission, you may not create
              frames around our Webpages that alter in any way the visual presentation or
              appearance of our Website.
              <br />
              <br /> Content Liability
              <br /> We shall not be hold responsible for any content that appears on your
              ...
              <br /> Your Privacy
              <br /> Please read{' '}
              <Link className="font-medium text-blue-600" href="/privacy-policy">
                Privacy Policy
              </Link>
              <br />
              <br /> Reservation of Rights
              <br /> We reserve the right to request that you remove all links or any
              particular link to our Website. You approve to immediately remove all links
              to our Website upon request. We also reserve the right to amen these terms
              ...
              <br /> If you find any link on our Website that is offensive for any reason,
              ...
              directly.
              <br /> We do not ensure that the information on this website is correct, we
              ...
              <br />
              <br /> Disclaimer
              <br /> To the maximum extent permitted by applicable law, we exclude all
              ...
              misrepresentation;
              <br /> limit any of our or your liabilities in any way that is not permitted
              under applicable law; or
              <br /> exclude any of our or your liabilities that may not be excluded under
              applicable law.
              <br /> The limitations and prohibitions of liability set in this Section and
              ...
              <br /> As long as the website and the information and services on the
