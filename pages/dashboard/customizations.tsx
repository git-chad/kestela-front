  ...
  return (
    <div className="mx-auto my-20 max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col">
      ...
      <div className="w-full flex justify-start items-center mb-8">
        ...
        <button className="bg-[#5064FF] py-2 px-8 rounded-md text-white mr-8">
          save
        </button>
        {currentCategory !== "All Templates" && (
          <button className="bg-[#333] py-2 px-8 rounded-md text-white">remove</button>
        )}
      </div>
                ...
                {filteredTemplates.map((template) => (
                  ...
                  >
                    ...
                    <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                      <input type='text' placeholder='name' className="block rounded-md bg-white py-2 w-full placeholder:text-gray-400 sm:text-sm sm:leading-6 border-gray-100" />
                    </td>
                  </motion.tr>
                ))}
              </tbody>
