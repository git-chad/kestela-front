...
import { ChartBarIcon, HomeIcon, InboxIcon, UsersIcon, LinkIcon, AdjustmentsHorizontalIcon } from '@heroicons/react/24/outline'
import { signOut } from "next-auth/react"

const navigation = [
  { name: 'Dashboard', icon: HomeIcon, href: '/dashboard' },
  { name: 'Integrations', icon: AdjustmentsHorizontalIcon, href: '/dashboard/integrations', count: 1 },
